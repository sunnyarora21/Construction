...
class ForgotPasswordViewController: UIViewController {
    ...
    @IBOutlet weak var viewForSendBtn: UIView!
    ...
    func initalSetUp() {
        viewForSendBtn.layer.cornerRadius = 5
        viewForSendBtn.layer.borderColor = UIColor.white.cgColor
        viewForSendBtn.layer.borderWidth = 1.5
        ...
        viewForSendBtn.layer.shadowOpacity = 10.0
        viewForSendBtn.layer.shadowOffset = CGSize(width: 5.0, height: 5.0)
        viewForSendBtn.layer.shadowRadius = 3.0
        viewForSendBtn.layer.shadowColor = UIColor.lightGray.cgColor
    }
